...
class EnablementRequest(models.Model):
    ...
    sales_initiator = models.ForeignKey(User, limit_choices_to= Q( groups__name = 'Sales'), related_name='sales_representative')

    assigned_engineer = models.ForeignKey(User, null=True, blank=True, unique=False, limit_choices_to= Q( groups__name = 'Enablement'), related_name='enablement_engineer')

    creation_timestamp = models.DateTimeField(auto_now_add=True)

    configuration_details = models.ForeignKey('ConfigurationDetails')
